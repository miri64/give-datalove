# Django settings for datalove project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dataloverz.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '070pajaexrqu*$-69_dm=1yhssrgy83malw=sf5cezv6*p75#&'
